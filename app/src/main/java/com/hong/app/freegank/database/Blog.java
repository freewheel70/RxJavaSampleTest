...
import com.hong.app.freegank.utils.DateUtil;
...
public class Blog extends BaseModel {
    ...
    public static boolean isBlogCollected(String blogID) {
        Blog blog = SQLite.select()
                .from(Blog.class)
                .where(com.hong.app.freegank.database.Blog_Table.blogID.eq(blogID))
                .querySingle();
    ...
    public static Blog getBlogById(String blogID) {
        Blog blog = SQLite.select()
                .from(Blog.class)
                .where(com.hong.app.freegank.database.Blog_Table.blogID.is(blogID))
                .querySingle();
    ...
    public static List<Blog> getAllNonRemovedFavouriteBlogs() {
        return SQLite.select()
                ...
                .orderBy(com.hong.app.freegank.database.Blog_Table.publishedAt, false)
                .queryList();
    }
