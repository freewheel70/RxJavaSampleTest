 ...
 */
public class AndroidBlogFragment extends BaseBlogFragment {
    ...
    protected List<BlogBean> requestBlogList() throws JSONException, ParseException {
        return GankNetworkManager.getBlogList(GankNetworkManager.TYPE_ANDROID,  getSIZE_OF_IMAGES_PER_REQUEST(), getCurrentPage());
    }
}
